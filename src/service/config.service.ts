...
export const configApi = (contentTypeJson: boolean = true) => {
  const localToken = localStorage.getItem("pulpaToken");
...
export const saveLocalStorage = (data: TDataLocal, hasToken: boolean = false) => {
  if (hasToken) {
    localStorage.setItem("pulpaToken", data.token);
    localStorage.setItem("pulpaRefreshToken", data.refreshToken);
  }
  localStorage.setItem("pulpaName", data.name);
  localStorage.setItem("pulpaEmail", data.email);
  localStorage.setItem("pulpaAdmin", data.admin);
  localStorage.setItem("pulpaPhoto", data.photo);
  localStorage.setItem("pulpaModules", JSON.stringify(data.modules));
};

export const removeLocalStorage = () => {
  localStorage.removeItem("pulpaToken");
  localStorage.removeItem("pulpaRefreshToken");
  localStorage.removeItem("pulpaName");
  localStorage.removeItem("pulpaEmail");
  localStorage.removeItem("pulpaAdmin");
  localStorage.removeItem("pulpaPhoto");
  localStorage.removeItem("pulpaModules");
};
