...
export const Autorization = () => {
    ...
    useEffect(() => {
        ...
        if(!token) {
            ...
            const admin = localStorage.getItem("pulpaAdmin");
            const name = localStorage.getItem("pulpaName");
            const email = localStorage.getItem("pulpaEmail");
            const photo = localStorage.getItem("pulpaPhoto");
            const nameCompany = localStorage.getItem("pulpaNameCompany");
            const nameStore = localStorage.getItem("pulpaNameStore");
